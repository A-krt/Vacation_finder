...
from flight_adapter=flight_adapter,from pathlib import Path
    ...
    logger.info("Verification links CSV opgeslagen op %s", shortlist_exports["verification_links_csv"])
